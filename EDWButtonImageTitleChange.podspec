#
#  Be sure to run `pod spec lint EDWButtonImageTitleChange.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "EDWButtonImageTitleChange"

  s.homepage     = "https://github.com/jinjinEdward/EDWButtonImageTitleChange"
